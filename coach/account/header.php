<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="index.html" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">AHM</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-header small text-uppercase">
            <span class="menu-header-text">My Customers</span>
        </li>
        ...
        <li class="menu-header small text-uppercase">
            <span class="menu-header-text">Exercices & programs</span>
        </li>

        <li class="menu-item">
            <a href="exercices.php" class="menu-link">
                <i class='menu-icon bx bx-plus-medical'></i>
                <div data-i18n="Basic">Add exercices</div>
            </a>
        </li>
        ...
        <li class="menu-item">
            <a href="program.php" class="menu-link">
                <i class='menu-icon bx bx-plus-medical'></i>
                <div data-i18n="Basic">Add Program</div>
            </a>
        </li>
        <li class="menu-header small text-uppercase">
