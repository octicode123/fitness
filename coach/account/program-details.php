...
if (isset($_GET["id"]) && !empty($_GET["id"])) {
    ...
    $program = $pdo->prepare("SELECT * FROM training_program WHERE coach_id=:coach_id and id_training=:id_training LIMIT 1");
    $program->bindParam(':coach_id', $coach_id);
    $program->bindParam(':id_training', $id_training);
    $program->execute();
    $result_program = $program->fetch();
    if ($result_program) {
?>
        <!DOCTYPE html>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form id="programADD" method="POST">
                                        <div class="row mb-3 mt-3">
                                            <div class="col-lg-4 col-md-4 col-12">
                                                <div class="mb-3">
                                                    ...
                                                    <select id="defaultSelect" class="form-select" name="customer">
                                                        ...
                                                        $customer->bindParam(':user_id', $result_program["user_id"]);
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select id="defaultSelect" class="form-select" name="day_of_week">
                                                        ...
                                                        foreach ($daysOfWeek as $day) {
                                                            $selected = ($result_program["day_of_week"] == $day) ? "selected" : "";
                                            ...
                                            <div class="col-lg-4 col-md-4 col-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="email" name="title" value="<?php echo $result_program["title"]; ?>" placeholder="Program name" />
                                                </div>
                                            ...
                                            <div class="col-lg-4 col-md-4 col-12">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group input-group-merge">
                                                        <input type="text" class="form-control" name="duration" value="<?php echo $result_program["duration"]; ?>" placeholder="30,60......" aria-label="Recipient's username" aria-describedby="basic-addon33">
                                        ...
                                        <div class="row mb-3 mt-3">
                                        <?php
// Fetch IDs of exercises in the current training program
$training_exercises_stmt = $pdo->prepare("SELECT * FROM exercice_training_program WHERE id_training=:id_training");
$training_exercises_stmt->bindParam(':id_training', $id_training);
$training_exercises_stmt->execute();
$training_exercise_ids = $training_exercises_stmt->fetchAll();

// Fetch all exercises belonging to the coach
$exercises_stmt = $pdo->prepare("SELECT * FROM exercises WHERE coach_id=:coach_id");
$exercises_stmt->bindParam(':coach_id', $coach_id);
$exercises_stmt->execute();
$result_exercises = $exercises_stmt->fetchAll();

// Check if there are any exercises
if (count($result_exercises) > 0) {
    foreach ($result_exercises as $row) {
        $exercise_id = $row["id_exercise"];
        $checked = in_array($exercise_id, $training_exercise_ids) ? "checked" : "";
...
?>
        ...
        <?php 
        foreach($training_exercise_ids as $train){
            if($train["id_exercice"]==$exercise_id){?>
            <div class="col-lg-4 col-md-4 col-12">
            <div class="mb-3">
                <div class="input-group mb-3">
                    <div class="input-group-text">
                        <input class="form-check-input mt-0" type="checkbox" name="exercise_id[]" value="<?php echo $exercise_id; ?>" aria-label="Checkbox for following text input" checked>
                    </div>
   ...
   <div class="col-lg-4 col-md-4 col-12">
            <div class="mb-3">
                <input type="number" class="form-control" id="exampleFormControlInput1" value="<?php echo $train["sets"];?>" name="sets[]" placeholder="sets">
            </div>
        </div>
        <div class="col-lg-4 col-md-4 col-12">
            <div class="mb-3">
            ...
            <div class="mb-3">
                <div class="input-group mb-3">
                    <div class="input-group-text">
                        <input class="form-check-input mt-0" type="checkbox" name="exercise_id[]" value="<?php echo $exercise_id; ?>" aria-label="Checkbox for following text input">
                    </div>
                    <input type="text" class="form-control" value="<?php echo $row["title"]; ?>" disabled >
                </div>
            </div>
...
<?php
    ...
    echo "You don't have any exercises.";
}
?>
